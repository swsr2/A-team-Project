...
<div id="loginBar">
	...
	<c:choose>	
		...
		<ul id="loginBarList">
			<li>${member.name }님 <a href="https://kauth.kakao.com/oauth/logout?client_id=7c06fcfbfeffe9bdd6963f11f30aaf2d&logout_redirect_uri=http://54.180.105.105:8080/project/kakao/kakaoLogout.do"> 로그아웃</a></li>
