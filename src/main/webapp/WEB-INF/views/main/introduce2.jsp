...
<body>
	...
	<table align="center" class="info">
		<tr>
			<td><img src="${path }/resources/image/jejuemo4.jpg" style="float:left;width:42px;height:42px;"></td>
			<td><h3><p>'제주가고싶조'는 제주도를 여행하고자 하는 여행자들에게 맛집, 관광지, 액티비티 등 제주도와 <br>
					관련된 정보를 제공함으로써 편리하게 여행을 할 수 있도록 돕고자 만들어 졌습니다.</p></h3></td>
		</tr>
		<tr>
				<td><img src="${path }/resources/image/jejuemo2.jpg" style="float:right;width:42px;height:42px;"></td>
				<td><h3><p>여행 일정짜기 어려울땐 육지사람부터 제주도민까지 모두가 좋아할만한 코스들로 준비했으니 <br>
				찜하기를 하여 내 일정짜기에 추가할 수 있어요.</p></h3></td>
		</tr>		
		<tr>
				<td><img src="${path }/resources/image/jejuemo3.jpg" style="float:left;width:42px;height:42px;"></td>
