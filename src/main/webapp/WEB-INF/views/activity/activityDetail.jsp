...
<body>
    ...
    <table align="center">
    	<tr>
     	...
     	<tr>
 			<td colspan="2" align="center"><h2>${activity.ac_title }</h2>
     	...
     	<tr>
 			...
 			<td>${activity.ac_phoneNo }</td>
     	</tr>
     	<tr>
 			<td width="100">지번주소 :</td>
 			<td>${activity.ac_address }</td> 
     	</tr>
     	<tr>
 			<td width="100">도로명 주소 :</td>
 			<td>${activity.ac_roadAddress }</td>
     	</tr>
     	<tr>
 			<td colspan="2">
	...
	// 주소로 좌표를 검색합니다
	geocoder.addressSearch("${activity.ac_roadAddress}", function(result, status) {
    ...
    // 정상적으로 검색이 완료됐으면 
     if (status === kakao.maps.services.Status.OK) {
        ...
        var infowindow = new kakao.maps.InfoWindow({
            content: '<div style="width:150px;text-align:center;padding:6px 0;"><a href="https://map.kakao.com/link/search/${activity.ac_title}">${activity.ac_title}</a></div>'
        });
